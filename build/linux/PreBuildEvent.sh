...
if [ -d $SOL_HOME/include/xrce/version.h ]
then rm $SOL_HOME/include/xrce/version.h
fi

sed "s/$WCREV_KEY/$WCREV_VAL/g" ../version.h.in | sed "s/$WCDATE_KEY/$WCDATE_CHANGE/g" > $SOL_HOME/include/xrce/version.h
